...
public final class JtesourcewordcardGenerated {
	public static final String JTE_NAME = "vocabulary-page/flashcard/source-word-card.jte";
	public static final int[] JTE_LINE_INFO = {0,0,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,13,13,13,13,13,15,15,16,16,16,16,16,16,16,16,16,17,17,18,18,20,20,21,21,21,22,22,22,2,2,2,2};
	private static final gg.jte.runtime.BinaryContent BINARY_CONTENT = gg.jte.runtime.BinaryContent.load(JtesourcewordcardGenerated.class, "JtesourcewordcardGenerated.bin", 258,10,33,8,1,20,5,62,85,12);
	...
	public static void render(gg.jte.html.HtmlTemplateOutput jteOutput, gg.jte.html.HtmlInterceptor jteHtmlInterceptor, WordCardAttribute attribute) {
		...
		jteOutput.writeUserContent(String.join(" ", attribute.sourceWord()));
