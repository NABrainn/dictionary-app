...
public class TranslationController {
    ...
    public String findByTargetWord(Model model,
        ...
        try {
            ...
            model.addAttribute("translationAttribute", result.value());
            return "document-page/translation/update/update-translation-form";
            ...
            return "document-page/translation/add/add-translation-form";
    ...
    public String updateSourceWords(Model model,
        ...
        try {
            ...
            return "document-page/translation/update/update-source-words-form";
        } catch (InvalidInputException e) {
    ...
    public String deleteSourceWord(Model model,
        ...
        try {
            ...
            return "document-page/translation/source-words-list";
        } catch (InvalidInputException e) {
